...
public class AddServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        AddServlet.openConnection();
        String nom= req.getParameter("name");
        String email = req.getParameter("email");
        int tel = Integer.parseInt(req.getParameter("tel"));
        this.ajoutcontact(nom,email,tel);
        PrintWriter pr=resp.getWriter();
        pr.write("Contact Ajoute ");
        AddServlet.afficherContact(resp);
    }
    ...
    public static void ajoutcontact(String nom, String email, int tel) {
        try {
            String query = "INSERT INTO users(name, email, tel) VALUES (?,?,?)";
